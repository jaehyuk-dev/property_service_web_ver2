...
class MainViewState extends State<MainView> {
  ...
  Future<void> _handleLogout() async {
    // DialogUtils의 showConfirmDialog 사용
    final shouldLogout = await DialogUtils.showConfirmDialog(
      context: context,
      title: '로그아웃',
    ...
    if (shouldLogout) {
      try {
        ...
        // 부분 로그아웃 (이메일만 저장)
        await _authService.partialLogout();
        ...
        // 에러 처리 - DialogUtils.showAlertDialog 사용
